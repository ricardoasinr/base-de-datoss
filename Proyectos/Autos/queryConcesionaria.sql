...
CREATE TABLE serie(
  codequipo decimal(10,0) NOT NULL, f
  nrochasis int not NULL,
...
CREATE TABLE venta (
 ...
 insert into tipoequipo values ('12345','778','Luz azul');
...
insert into automovil values('4324','34566','12346','negro','20190518','Japon','5','En Stock')
insert into automovil values('4325','34566','12346','Rojo','20190518','Japon','5','Vendido')
...
update automovil set Estado = 'Vendido' where NroChasis = '2001'
...
select nrochasis, Estado from automovil
SELECT CAST(NroChasis AS varchar(10)) FROM automovil
